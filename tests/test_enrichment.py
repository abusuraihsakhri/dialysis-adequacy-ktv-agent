"""
Automated Pytest for dialysis-adequacy-ktv-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    PredictiveEngine,
    PostdialysisEngine,
    PhosphorusalbuminEngine,
    DialysisadequacyktvagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = DialysisadequacyktvagentEnrichmentSuite()
